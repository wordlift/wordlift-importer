...
/**
 * Define the Wordlift_Another_Instance_Is_Running_Exception exception
 * which is thrown when an instance of the task is already running.
 *
 * @since 1.0.0
 */
class Wordlift_Task_Another_Instance_Is_Running_Exception extends Exception {
}
 ...
 * @since 1.0.0
 */
class Wordlift_Task_Single_Instance_Task_Runner {
	 ...
	 *
	 * @since 1.0.0
	 * @var Wordlift_Task $task The {@link Wordlift_Task} to execute.
	 * @access private
	 */
	private $task;
	 ...
	 *
	 * @since 1.0.0
	 * @var Wordlift_Task_Progress[] $callbacks An array of {@link Wordlift_Progress}.
	 * @access private
	 */
	private $callbacks;
	 ...
	 *
	 * @param Wordlift_Task $task The {@link Wordlift_Task} instance.
	 ...
	 *
	 * @throws Wordlift_Task_Another_Instance_Is_Running_Exception if the task is already running.
	 * @since 1.0.0
	 */
	public function start( $limit = 0, $offset = 0 ) {
		...
		if ( ! $this->force && $this->is_running() ) {
			throw new Wordlift_Task_Another_Instance_Is_Running_Exception();
		}
